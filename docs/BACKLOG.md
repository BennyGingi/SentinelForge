...
- Prometheus/Grafana, cloud deployment. (Read-only HTTP API shipped — Issue #035, see [`docs/architecture/collector-api.md`](architecture/collector-api.md); Docker and Kubernetes shipped — Issues #029/#030, see [`docs/architecture/docker.md`](architecture/docker.md) and [`docs/architecture/kubernetes.md`](architecture/kubernetes.md).)
- `detector-python/` — reserved directory, no implementation yet.
